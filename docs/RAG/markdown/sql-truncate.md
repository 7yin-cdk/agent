...
version: "18"
source: "official"
source_url: "https://www.postgresql.org/docs/18/sql-truncate.html"
document: "sql-truncate"
title: "PostgreSQL: Documentation: 18: TRUNCATE"
chapter: "PostgreSQL: Documentation: 18: TRUNCATE"
---
...
`TRUNCATE` can be used for foreign tables if supported by the foreign data wrapper, for instance, see postgres\_fdw.
