...
version: "18"
source: "official"
source_url: "https://www.postgresql.org/docs/18/hot-standby.html"
document: "hot-standby"
title: "PostgreSQL: Documentation: 18: 26.4. Hot Standby"
chapter: "PostgreSQL: Documentation: 18: 26.4. Hot Standby"
---
...
When the hot\_standby parameter is set to true on a standby server, it will begin accepting connections once the recovery has brought the system to a consistent state and be ready for hot standby. All such connections are strictly read-only; not even temporary tables may be written.
...
Users can control whether a log message is produced when WAL replay is waiting longer than `deadlock_timeout` for conflicts. This is controlled by the log\_recovery\_conflict\_waits parameter.
