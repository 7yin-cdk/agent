...
version: "18"
source: "official"
source_url: "https://www.postgresql.org/docs/18/explicit-joins.html"
document: "explicit-joins"
title: "PostgreSQL: Documentation: 18: 14.3. Controlling the Planner with Explicit JOIN Clauses"
chapter: "PostgreSQL: Documentation: 18: 14.3. Controlling the Planner with Explicit JOIN Clauses"
---
...
To force the planner to follow the join order laid out by explicit `JOIN`s, set the join\_collapse\_limit run-time parameter to 1. (Other possible values are discussed below.)
