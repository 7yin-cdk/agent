...
version: "18"
source: "official"
source_url: "https://www.postgresql.org/docs/18/using-explain.html"
document: "using-explain"
title: "PostgreSQL: Documentation: 18: 14.1. Using EXPLAIN"
chapter: "PostgreSQL: Documentation: 18: 14.1. Using EXPLAIN"
---
...
you will find that `tenk1` has 345 disk pages and 10000 rows. The estimated cost is computed as (disk pages read \* seq\_page\_cost) + (rows scanned \* cpu\_tuple\_cost). By default, `seq_page_cost` is 1.0 and `cpu_tuple_cost` is 0.01, so the estimated cost is (345 \* 1.0) + (10000 \* 0.01) = 445.
