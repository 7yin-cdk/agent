...
version: "18"
source: "official"
source_url: "https://www.postgresql.org/docs/18/transaction-id.html"
document: "transaction-id"
title: "PostgreSQL: Documentation: 18: 67.1. Transactions and Identifiers"
chapter: "PostgreSQL: Documentation: 18: 67.1. Transactions and Identifiers"
---
...
When a top-level transaction with a (non-virtual) xid commits, it is marked as committed in the `pg_xact` directory. Additional information is recorded in the `pg_commit_ts` directory if track\_commit\_timestamp is enabled.
